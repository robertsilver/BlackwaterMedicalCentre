...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        <img src="Images/SurgeryCatchement.jpg" alt="Surgery Catchment" />
    </p>
    <h2>
        <a name="1"></a>Surgery Opening Hours</h2>
    <h3>Blackwater Medical Centre
    </h3>
    <table border="0" cellpadding="0" cellspacing="2" bgcolor="#FFFFFF" class="datatable">
        <tr>
            <td bgcolor="#B6288B">
                <table width="450" border="0" cellpadding="6" cellspacing="1" bordercolor="#93B6D5">
                    <tr>
    ...
    <p>
        ...
        surgeries due to directives from NHS England.
    </p>
    <h3>Heybridge Surgery
    </h3>
    <table style="border: 1px solid black">
        ...
        <tr>
            <td style="border: 1px solid black">Tuesday
            </td>
            <td style="border: 1px solid black">08.30 to 11.30
            </td>
            <td style="border: 1px solid black;">Dr Haeger
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid black; background-color: #DFDDFF;">Wednesday
            </td>
            <td style="border: 1px solid black; background-color: #DFDDFF;">08.30 to 11.00
            </td>
            <td style="border: 1px solid black; background-color: #DFDDFF;">Dr Roper
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid black"></td>
            <td style="border: 1px solid black">08.40 to 11.10
            </td>
            <td style="border: 1px solid black">Dr Teatino
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid black; background-color: #DFDDFF;">Thursday
            </td>
            <td style="border: 1px solid black; background-color: #DFDDFF;">08.30 to 11.30
            </td>
            <td style="border: 1px solid black; background-color: #DFDDFF;">Dr Geranmayeh
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid black; background-color: #DFDDFF;"></td>
    ...
    <h3>Emailing Us</h3>
    <p>
        If you wish to email us, please <a href="mailto:blackwater.medicalcentre@nhs.net" target="_blank">click here</a>.
    </p>
    <h3>Appointments</h3>
    <p>
        Arriving late/providing short notice that you will be late - It will be at the GP's
        discretion if they will/will not see the patient, which may be at the end of surgery.
    </p>
    <h3>Cancellations</h3>
    <p>
        Patients MUST provide 24-hours notice. A warning letter will be sent to patients
        who do not co-operate, which may result in removal from the Practice Register.
    </p>
    <h3>Parking</h3>
    <p>
        The practice has limited parking designated for patients' use whilst attending the
        surgery. Abuse of this facility causes congestion, which could delay emergency services.
